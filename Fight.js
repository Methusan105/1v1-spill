...
function animer() {
  ...
  if (spiller1.angriper && spiller1.framesCurrent === 4) {
    spiller1.angriper = false;
  }
  ...
  if (spiller2.angriper && spiller2.framesCurrent === 2) {
    spiller2.angriper = false;
  }
...
Når knappen r trykkes så viderefører denne nettsiden til index.html
 */
